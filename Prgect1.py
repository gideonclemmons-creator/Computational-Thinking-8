...
input()
print("I bet it was 1 or 2 cool right i just guessed the number")
input()
...
print("no try again")
input()
print("no but closer try again")
input()
print(r"Hah you weren't close at all but I will give it to you the answer was 67 you should have gotten it the first time :)")
input()
print(f"thanks for talking to me {name} :)")